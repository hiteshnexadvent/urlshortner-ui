...
export default function Premium() {
  return (
    <div style={{ backgroundColor: '#000214', width: '100%', height: 'auto', paddingBottom: '50px', color: 'white', fontFamily: 'Arial, sans-serif' }}>
      ...
      <h1 style={{ textAlign: 'center', fontSize: '48px', marginTop: '40px', marginBottom: '60px', color: '#fff',fontWeight:'700' }}>Link Shorten Plans</h1>
      ...
      <div style={{ display: 'flex', justifyContent: 'center', gap: '30px', flexWrap: 'wrap' }}>
        ...
        {/* -------------------- qr comparison */}
         ...
         <h1 style={{ textAlign: 'center', fontSize: '48px', marginTop: '60px', marginBottom: '60px', color: '#fff',fontWeight:'700' }}>QR Scanner Plans</h1>
      ...
      <div style={{ display: 'flex', justifyContent: 'center', gap: '30px', flexWrap: 'wrap' }}>
        ...
        <tbody>
          <tr>
            <th style={thStyle} colSpan={5}>QR Managment</th>
            {/* <th style={thStyle}>User 1</th>
            <th style={thStyle}>User 2</th>
            <th style={thStyle}>User 3</th> */}
          </tr>
